...
In fact, the C++ standard covers much of the same ground in its definition
...
Then changes to either \co{x} or \co{y}
...
Until that time, pure mathematics cannot help us simply because it is
impossible to say whether or not there is a semantic dependency from
\co{y} to \co{z} without reference to a specific implementation.
