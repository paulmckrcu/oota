...
% @@@
% 1: rfe, not rf.
% 2: Rules of arithmetic (*0).
% 3: Many-to-one sdep (*0 + ... )
% 4: Compiler knowledge, cross-thread special case.
% 5: Different stores.
% 6: "If" statements.
% 7: Matching up stores.
% Semantic dependencies depend on execution.
% @@@
...
are not strict functions of source code.
...
Section~\ref{sec:Architectures Influence the Behavior of Compilers}
show that machine architectures influence C++ compilers.
Section~\ref{sec:Optimizations Influence the Behavior of Compilers}
show, perhaps unsurprisingly, that optimizers influence C++ compilers.
Section~\ref{sec:Users Influence the Behavior of Compilers}
shows that compilers can also be influenced by their users.
Section~\ref{sec:Global Optimization Can Destroy Dependencies}
