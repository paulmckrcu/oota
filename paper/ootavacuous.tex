...
Listing~\ref{lst:Wording Additions to the Standard}
...
\begin{listing*}[tbp]
\begin{quote}
	[ Note N --- An implementation that translates to instruction
	...
	[ Note N+1 --- Unlike abstract machines, physical machines
	...
	--- End note. ]
\end{quote}
\caption{Wording Additions to the Standard}
\label{lst:Wording Additions to the Standard}
\end{listing*}
