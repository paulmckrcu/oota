...
\begin{listing}[tbp]
% Constructed by litmus2table.sh and modified by hand
{
\small
\begin{tabular}{r|l|l}
& \multicolumn{1}{c}{T0} & \multicolumn{1}{c}{T1} \\
...
\vspace{0.1in}
Condition (0:r0=42 $\wedge$ 1:r1=42)
sometimes satisfied.
}
\caption{OOTA Cycle}
...
to \co{y} by line~2.
And since the load from \co{y} has been removed, it cannot possibly
...
\end{verbatim}
\end{quote}
For values of \co{x} small enough not to cause overflow, the abstract machine is
