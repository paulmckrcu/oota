...
C++ implementations.
(The as-if rule permits optimizations where the optimized code's
...
Only semantic dependencies are relevant to OOTA.)
Here the semantic dependencies are trivial because the values stored simply
...
and because closing an OOTA cycle comprising a sequence of commmunications
...
These simple-seeming ideas conceal considerable complexity,
