...
code~\cite{PaulEMcKenney2020RelaxedGuideRelaxed}.\footnote{
	Throughout this paper, variables whose names begin with ``\co{r}''
	denote private per-thread variables (``registers''),
...
(1)~Extend these results to some classes of interpreters and JITs on
...
One conclusion to be drawn from this work is that in this context,
