...
code~\cite{PaulEMcKenney2020RelaxedGuideRelaxed}.\footnote{
	...
	followed by a number denote private per-process variables
	(``registers''),
	and other names denote shared variables.
	All shared-variable accesses are relaxed atomic.}
First, process P0's line~1 does a load from \co{x} into \co{r1},
...
This, combined with the default-zero initialization, explains why this
OOTA result has not been observed on real implementations.
