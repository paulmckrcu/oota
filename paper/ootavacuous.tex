...
though it may have been designed only to comply with loose C++.
...
Although one would expect an optimizing compiler to discard the unused
loads into \co{r1} and \co{r3}, one could imagine a perverse compiler
instead using per-thread analysis to translate this into the machine-code
equivalent of:
\begin{quote}
\begin{verbatim}
int r1 = (x != 0);
