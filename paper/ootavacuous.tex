...
\begin{document}
\title{D3692R4: How to Avoid OOTA Without Really Trying}
...
\begin{itemize}
\item	D3692R4 updates the C++ working draft to N5032 and applies
	feedback from CWG.
...
\begin{quote}
	...
	atomic acesses as though they were volatile do not produce
	...
	but that otherwise treats non-volatile atomic accesses as though
	they were volatile, does not produce out-of-thin-air values for
	a program free of undefined behavior.
	The possibility of out-of-thin-air value remains for
