...
% @@@ Future directions at some point.
...
hope it will provide a starting point for discussions that move the
...
This may strike some people as too compromising, in that a given piece
...
not count as OOTA because according to our definition, the
...
\section{To Be Moved Or Removed...}
...
This paper focuses further on compilers that do only local per-thread
analysis.
Further explorations could consider some classes of global analysis,
for example, analyses that demonstrate that a given expression
will always evaluate to a particular constant.
