...
to a given store when a change in the value loaded that can change the
value stored.}
...
for which the implementation is forbidden from assuming that the
...
\subsection{@@@ This marks the end of the reworked material}
