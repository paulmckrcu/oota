...
in sdep $\cup$ rf [@@@ Reference needed],
...
As you can see, most of the measurements show that the winning store
was not the last store, even on x86.
...
say, most frequently, the last load of the old value executes about 60
timestamp periods (about 30~nanoseconds) \emph{after} the store that
overwrote that same old value.
