...
\begin{abstract}
	...
	atomics from occurring in correctly constructed C++ programs
	running on correctly constructed C++ implementations in our
	current universe.
...
cycles from UB-free programs using volatile atomics.
...
OOTA cycles from UB-free programs using non-volatile as well as volatile
atomics.
