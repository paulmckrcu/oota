...
sensitive to perturbations, which makes perfect sense to that paper's
...
An OOTA cycle (also known as a causal cycle) is a cycle in the
memory-model sense involving the load-buffering (LB) pattern.
