...
Others, current authors included, have defined an OOTA cycle as a
...
value might be zero ($\frac{1}{2}$ truncated) or two ($\frac{2}{1}$).
This indeterminacy is why many coding guidelines prohibit side effects
in expressions, but the above code nevertheless conforms to the standard.
...
with standards, implementations, and users all having
influence~\cite{KayvanMemarian2016DepthOfC-1,KayvanMemarian2016DepthOfC-2}.
Nevertheless, because volatile atomics constitute observable
...
We are grateful to David Goldblatt, Jade Alglave, Alan Stern, and Peter
...
of the authors, and the appearance of a name in this paragraph does
