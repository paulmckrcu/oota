...
The SAT-solver-based \co{cbmc} tool, which is readily available,\footnote{
...
% @@@ More on cbmc in an appendix.

However, as will be seen in later sections, in some special but
commonly occurring circumstances, there are easier ways.
