...
Section~\ref{sec:Volatile and Quasi Volatile Accesses},
implementations must not behave as if the source code has
additional:
...
Listing{lst:Do Not Duplicate Atomic Loads}.
...
Therefore, C++ implementations should not invent loads, and should
not even duplicate them.
