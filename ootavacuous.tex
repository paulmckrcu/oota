...
defining an OOTA cycle as a cycle in sdep $\cup$ rfe, where rfe is the
...
In addition,such accesses are still subject to the memory model.
...
prevents this OOTA cycle on real-world C++ implementations.
...
Figure~\ref{lst:Causality Test Case 12}
