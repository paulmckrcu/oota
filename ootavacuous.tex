...
Some other tools respond to complexity by consuming all available CPU
and memory, which can also be interpreted as a good and sufficient
warning message.
...
While taking this approach sacrifices significant generality, it has
the not insignificant benefit of greatly reducing the cost of dependency
analysis, potentially all the way to zero.
