...
This implies that volatile load-acquire's do not necessarily synchronize with
volatile store-releases in the sense of the C++ memory model,\footnote{
	For example, roughly speaking, they might instead synchronize
	with load-acquires and store-releases in device firmware.}
