...
definition of OOTA.
This section provides more involved examples to drive this point home.
...
OOTA cycles nor OOTA-like behavior in compiler-based C++ implementations.
...
The first step towards these more involved examples is shown in
...
Within the confines of the C++ abstract machine (omitting the no-OOTA
