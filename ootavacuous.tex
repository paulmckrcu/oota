...
equivalent, it is difficult to imagine that a reasonable compiler
...
But if \co{x} is a nonvolatile atomic, there are no worries about
data races.
In theory, if the \co{do_something_with()} call was not present
the compiler could still make the above transformation without
