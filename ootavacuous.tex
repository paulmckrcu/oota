...
loaded that can change the value stored.}
...
\subsection{Difficulties in Rigorously Defining ``Semantic Dependency''}
...
Because the stores executed on each branch of that "if" statement store
...
about whether there is a semantic dependency.
