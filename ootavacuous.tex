...
This forms the basis the quasi-volatile approach presented in
...
An example is given by the (forbidden) execution that satisfies the
...
and
Listing~\ref{lst:OOTA Multiplication Example, Initial Value 1}
can be thought of as being two different executions of the exact same
program.
...
each have only one OOTA cycle, and an execution having initial values
of (say) two could have at most two OOTA cycles, both of which are
