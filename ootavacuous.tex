...
On real systems, instructions require time to execute, even
when executed speculatively.
...
and the conditional on line~9 is evaluated nonspeculatively.\footnote{
