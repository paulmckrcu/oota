...
where rfe is the set of store-to-load links between different threads.
...
store in another thread, the standard generally does not require
the store to come before the load in any meaningful way.
...
corresponds to $W'$.
If $W'$ is in the initial or common portion of $H$ this is no
