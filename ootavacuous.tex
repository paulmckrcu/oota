...
\begin{abstract}
	...
	implementers
	(and this paper describes some of the challenges of coming to
	grips with the key notion of semantic dependency).
	...
	The OOTA problem is much more tractable at the hardware level
	than at the source level, thanks to existing formal hardware
	models, and
	we show that the constraints in these models prevent OOTA cycles
	involving only volatile atomics from occurring in
