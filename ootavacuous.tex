...
\begin{listing}[tbp]
\begin{verbatim}
@@ DisplayLitmus litmus/oota-causality-9.litmus @@
\end{verbatim}
...
\begin{listing}[tbp]
\begin{verbatim}
@@ DisplayLitmus litmus/oota-causality-9a.litmus @@
\end{verbatim}
...
result is to be forbidden.
The herd7 tool nevertheless reports this result and does not flag it as
an OOTA cycle.

\begin{listing}[tbp]
\begin{verbatim}
@@ DisplayLitmus litmus/oota-causality-10.litmus @@
\end{verbatim}
